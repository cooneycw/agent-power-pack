...
| **Phase 8 (US6)** — Plane + Wiki.js defaults | `cpp:init` is used on this repo to configure Plane + Wiki.js; open GH issues sync to Plane via `/spec:sync`; plan artifacts publish to Wiki.js automatically. |
...
├── src/agent_power_pack/       # Linter, generator, cpp:init, grill, secrets, cicd

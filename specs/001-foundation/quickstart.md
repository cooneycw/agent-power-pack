...
`tests/e2e/test_dual_attach.py` and `tests/integration/test_project_init_wizard.py`.
...
## 5. Bootstrap a NEW project with `project:init`
...
- **`project:init` connectivity check fails for Plane** — the wizard

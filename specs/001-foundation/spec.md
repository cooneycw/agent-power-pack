...
- **FR-015** A `cpp:init` skill MUST bootstrap a NEW project that uses
...
- **FR-016** `cpp:init` MUST offer a guided configuration step for the
...
- **SC-008** `cpp:init` on a fresh project produces a working agent-power-pack
